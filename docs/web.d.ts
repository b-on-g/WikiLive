...
declare namespace $ {
	...
	export class $company_template_logo_demo extends $mol_example_small {
		Logo( ): $company_template_logo
		sub( ): readonly(any)[]
		tags( ): readonly(any)[]
...
declare namespace $ {
	...
	type $company_template_button__title_company_template_button_demo_1 = $mol_type_enforce<
		string
		,
		ReturnType< $company_template_button['title'] >
	>
	type $company_template_button__title_company_template_button_demo_2 = $mol_type_enforce<
		string
		,
		ReturnType< $company_template_button['title'] >
	>
	export class $company_template_button_demo extends $mol_example_small {
		Login( ): $company_template_button
		Logout( ): $company_template_button
		title( ): string
		sub( ): readonly(any)[]
		tags( ): readonly(any)[]
		aspects( ): readonly(any)[]
...
declare namespace $ {
	...
	export class $company_template_docs extends $mol_app_demo {
		menu_title( ): string
