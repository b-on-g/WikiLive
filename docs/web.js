...
;
	($.$bog_wikilive_logo_demo) = class $bog_wikilive_logo_demo extends ($.$mol_example_small) {
		Logo(){
	...
	($mol_mem(($.$bog_wikilive_logo_demo.prototype), "Logo"));
...
;
	($.$bog_wikilive_button) = class $bog_wikilive_button extends ($.$mol_button_major) {};
...
;
	($.$bog_wikilive_button_demo) = class $bog_wikilive_button_demo extends ($.$mol_example_small) {
		Login(){
			const obj = new this.$.$bog_wikilive_button();
			(obj.title) = () => ("Войти");
			return obj;
		}
		Logout(){
	...
	($mol_mem(($.$bog_wikilive_button_demo.prototype), "Login"));
	($mol_mem(($.$bog_wikilive_button_demo.prototype), "Logout"));
...
;
	($.$bog_wikilive_docs) = class $bog_wikilive_docs extends ($.$mol_app_demo) {
		menu_title(){
			return "Демонстрации";
		}
		source_prefix(){
			return "https://github.com/b-on-g/WikiLive/tree/master/";
		}
		sources_uri(){
			return "https://github.com/b-on-g/WikiLive/";
		}
	};
