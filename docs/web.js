...
;
	($.$company_template_logo_demo) = class $company_template_logo_demo extends ($.$mol_example_small) {
		Logo(){
	...
	($mol_mem(($.$company_template_logo_demo.prototype), "Logo"));
...
;
	($.$company_template_button_demo) = class $company_template_button_demo extends ($.$mol_example_small) {
		Login(){
	...
	($mol_mem(($.$company_template_button_demo.prototype), "Login"));
	($mol_mem(($.$company_template_button_demo.prototype), "Logout"));
...
;
	($.$company_template_docs) = class $company_template_docs extends ($.$mol_app_demo) {
		menu_title(){
			return "Демонстрации";
		}
		source_prefix(){
			return "https://github.com/Lyumih/richtemplate/tree/master/";
		}
		sources_uri(){
			return "https://github.com/Lyumih/richtemplate/";
		}
	};
