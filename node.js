...
;
	($.$bog_wikilive_logo) = class $bog_wikilive_logo extends ($.$mol_icon_molecule) {};
...
var $;
(function ($) {
    $mol_style_attach("bog/wikilive/logo/logo.view.css", "[bog_wikilive_logo] {\n\tanimation: rotate 4s infinite;\n}\n\n@keyframes rotate {\n\t0% {\n\t\ttransform: rotate(0deg)\n\t}\n\n\t100% {\n\t\ttransform: rotate(360deg)\n\t}\n}\n");
})($ || ($ = {}));
...
;
	($.$bog_wikilive_table_view) = class $bog_wikilive_table_view extends ($.$mol_view) {
		table_title(next){
			if(next !== undefined) return next;
			return "Таблица";
		}
		Title_edit(){
			...
			(obj.value) = (next) => ((this.table_title(next)));
			(obj.hint) = () => ("Название таблицы");
			return obj;
		}
		col_add_click(next){
			if(next !== undefined) return next;
		...
		Add_col(){
			const obj = new this.$.$mol_button_minor();
			(obj.title) = () => ("+ Столбец");
			(obj.click) = (next) => ((this.col_add_click(next)));
			return obj;
		}
		row_add_click(next){
			if(next !== undefined) return next;
		...
		Add_row(){
			const obj = new this.$.$mol_button_minor();
			(obj.title) = () => ("+ Строка");
			(obj.click) = (next) => ((this.row_add_click(next)));
			return obj;
		}
		Tools(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.Add_col()), (this.Add_row())]);
			return obj;
		}
		Header(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.Title_edit()), (this.Tools())]);
			return obj;
		}
		col_ids(){
			return [];
		...
		table(){
			const obj = new this.$.$bog_wikilive_table();
			return obj;
		}
		sub(){
		...
		Cell(id){
			...
			(obj.value) = (next) => ((this.cell_val(id, next)));
			return obj;
		}
	};
	($mol_mem(($.$bog_wikilive_table_view.prototype), "table_title"));
	($mol_mem(($.$bog_wikilive_table_view.prototype), "Title_edit"));
	($mol_mem(($.$bog_wikilive_table_view.prototype), "col_add_click"));
	($mol_mem(($.$bog_wikilive_table_view.prototype), "Add_col"));
	($mol_mem(($.$bog_wikilive_table_view.prototype), "row_add_click"));
	($mol_mem(($.$bog_wikilive_table_view.prototype), "Add_row"));
	($mol_mem(($.$bog_wikilive_table_view.prototype), "Tools"));
	($mol_mem(($.$bog_wikilive_table_view.prototype), "Header"));
	($mol_mem(($.$bog_wikilive_table_view.prototype), "Grid"));
	($mol_mem_key(($.$bog_wikilive_table_view.prototype), "cell_val"));
	($mol_mem(($.$bog_wikilive_table_view.prototype), "table"));
	($mol_mem_key(($.$bog_wikilive_table_view.prototype), "Col_head"));
	($mol_mem_key(($.$bog_wikilive_table_view.prototype), "Cell"));
...
(function ($) {
    ...
    (function ($$) {
        ...
        __decorate([
            $mol_mem
        ], $bog_wikilive_table_view.prototype, "table_title", null);
        __decorate([
            $mol_mem
        ], $bog_wikilive_table_view.prototype, "columns", null);
        __decorate([
            $mol_mem
        ], $bog_wikilive_table_view.prototype, "rows", null);
        __decorate([
            $mol_mem
        ], $bog_wikilive_table_view.prototype, "head_cells", null);
        __decorate([
            $mol_mem_key
        ], $bog_wikilive_table_view.prototype, "cell_val", null);
        __decorate([
            $mol_action
        ], $bog_wikilive_table_view.prototype, "col_add_click", null);
        __decorate([
            $mol_action
        ], $bog_wikilive_table_view.prototype, "row_add_click", null);
...
var $;
(function ($) {
    $mol_style_define($bog_wikilive_table_view, {
        flex: {
            direction: 'column',
        },
        Header: {
    ...
    class $giper_baza_text extends $giper_baza_pawn {
        ...
        str(next) {
            if (next === undefined) {
                ...
                for (const unit of this.units()) {
                    if (unit.tag() === 'term')
                        str += $mol_schema_string.cast(land.sand_decode(unit));
                    else
...
;
	($.$bog_wikilive_profile_page) = class $bog_wikilive_profile_page extends ($.$mol_page) {
		player_id(){
			return "";
		}
		Avatar(){
		...
		Stat_created(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => (["Создано страниц:", (this.stat_created())]);
			return obj;
		}
		stat_edited(){
			return "0";
		...
		Stat_edited(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => (["Отредактировано:", (this.stat_edited())]);
			return obj;
		}
		stat_favorites(){
			return "0";
		...
		Stat_favorites(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => (["В избранном:", (this.stat_favorites())]);
			return obj;
		}
		Stats(){
			const obj = new this.$.$mol_view();
		...
		Favorites_list(){
			const obj = new this.$.$mol_list();
			(obj.rows) = () => ((this.favorite_rows()));
			return obj;
		}
		favorites_empty_text(){
			return "Нет избранных страниц";
		}
		Favorites_empty(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.favorites_empty_text())]);
			return obj;
		}
		Favorites_section(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([
				(this.Favorites_title()), 
				(this.Favorites_list()), 
				(this.Favorites_empty())
			]);
			return obj;
		}
		Recent_title(){
		...
		Recent_list(){
			const obj = new this.$.$mol_list();
			(obj.rows) = () => ((this.recent_rows()));
			return obj;
		}
		recent_empty_text(){
			return "Нет недавних страниц";
		}
		Recent_empty(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.recent_empty_text())]);
			return obj;
		}
		Recent_section(){
			const obj = new this.$.$mol_view();
		...
		recent_row_click(id, next){
			if(next !== undefined) return next;
			return null;
		}
		store(){
			const obj = new this.$.$bog_wikilive_store();
			return obj;
		}
		title(){
			return "Профиль";
		...
		body(){
			return [
				(this.Card()), 
				(this.Favorites_section()), 
				(this.Recent_section())
			];
		}
		Fav_row(id){
			const obj = new this.$.$mol_button_minor();
			(obj.title) = () => ((this.fav_row_title(id)));
			(obj.click) = (next) => ((this.fav_row_click(id, next)));
			return obj;
		}
		Recent_row(id){
			const obj = new this.$.$mol_button_minor();
			(obj.title) = () => ((this.recent_row_title(id)));
			(obj.click) = (next) => ((this.recent_row_click(id, next)));
			return obj;
		}
	};
	($mol_mem(($.$bog_wikilive_profile_page.prototype), "Avatar"));
	($mol_mem(($.$bog_wikilive_profile_page.prototype), "profile_name"));
	($mol_mem(($.$bog_wikilive_profile_page.prototype), "Name_edit"));
	($mol_mem(($.$bog_wikilive_profile_page.prototype), "Stat_created"));
	($mol_mem(($.$bog_wikilive_profile_page.prototype), "Stat_edited"));
	($mol_mem(($.$bog_wikilive_profile_page.prototype), "Stat_favorites"));
	($mol_mem(($.$bog_wikilive_profile_page.prototype), "Stats"));
	($mol_mem(($.$bog_wikilive_profile_page.prototype), "Card"));
	($mol_mem(($.$bog_wikilive_profile_page.prototype), "Favorites_title"));
	($mol_mem(($.$bog_wikilive_profile_page.prototype), "Favorites_list"));
	($mol_mem(($.$bog_wikilive_profile_page.prototype), "Favorites_empty"));
	($mol_mem(($.$bog_wikilive_profile_page.prototype), "Favorites_section"));
	($mol_mem(($.$bog_wikilive_profile_page.prototype), "Recent_title"));
	($mol_mem(($.$bog_wikilive_profile_page.prototype), "Recent_list"));
	($mol_mem(($.$bog_wikilive_profile_page.prototype), "Recent_empty"));
	($mol_mem(($.$bog_wikilive_profile_page.prototype), "Recent_section"));
	($mol_mem_key(($.$bog_wikilive_profile_page.prototype), "fav_row_click"));
	($mol_mem_key(($.$bog_wikilive_profile_page.prototype), "recent_row_click"));
	($mol_mem(($.$bog_wikilive_profile_page.prototype), "store"));
	($mol_mem(($.$bog_wikilive_profile_page.prototype), "page_selected"));
	($mol_mem_key(($.$bog_wikilive_profile_page.prototype), "Fav_row"));
	($mol_mem_key(($.$bog_wikilive_profile_page.prototype), "Recent_row"));
...
(function ($) {
    ...
    (function ($$) {
        ...
        __decorate([
            $mol_mem
        ], $bog_wikilive_profile_page.prototype, "player_id", null);
        __decorate([
            $mol_mem
        ], $bog_wikilive_profile_page.prototype, "profile_name", null);
        __decorate([
            $mol_mem
        ], $bog_wikilive_profile_page.prototype, "stat_created", null);
        __decorate([
            $mol_mem
        ], $bog_wikilive_profile_page.prototype, "stat_edited", null);
        __decorate([
            $mol_mem
        ], $bog_wikilive_profile_page.prototype, "stat_favorites", null);
        __decorate([
            $mol_mem
        ], $bog_wikilive_profile_page.prototype, "favorite_rows", null);
        __decorate([
            $mol_action
        ], $bog_wikilive_profile_page.prototype, "fav_row_click", null);
        __decorate([
            $mol_mem
        ], $bog_wikilive_profile_page.prototype, "recent_rows", null);
        __decorate([
            $mol_action
        ], $bog_wikilive_profile_page.prototype, "recent_row_click", null);
...
(function ($) {
    ...
    class $bog_wikilive_table extends $giper_baza_entity.with({
        Columns: $giper_baza_list_str,
        Row_ids: $giper_baza_list_str,
        Cells: $giper_baza_dict,
    }) {
        cell_val(row_id, col, next) {
            if (next !== undefined) {
    ...
    __decorate([
        $mol_action
    ], $bog_wikilive_table.prototype, "row_add", null);
    __decorate([
        $mol_action
    ], $bog_wikilive_table.prototype, "row_remove", null);
    __decorate([
        $mol_action
    ], $bog_wikilive_table.prototype, "col_add", null);
    __decorate([
        $mol_action
    ], $bog_wikilive_table.prototype, "col_remove", null);
    $.$bog_wikilive_table = $bog_wikilive_table;
    /** Вики-документ — entity в отдельном Land. */
    class $bog_wikilive_doc extends $giper_baza_entity.with({
    ...
    $.$bog_wikilive_doc = $bog_wikilive_doc;
    /** Профиль пользователя — живёт в home land. */
    class $bog_wikilive_profile extends $giper_baza_entity.with({
        Name: $giper_baza_atom_text,
    ...
    $.$bog_wikilive_profile = $bog_wikilive_profile;
    /** Реестр страниц в home land. */
    class $bog_wikilive_registry extends $giper_baza_entity.with({
        Pages: $giper_baza_list_link,
    }) {
    }
    $.$bog_wikilive_registry = $bog_wikilive_registry;
    /** Хранилище вики — glob, registry, CRUD. */
    class $bog_wikilive_store extends $mol_object {
        glob() {
        ...
        registry() {
            return this.home_land().Data($bog_wikilive_registry);
        }
        profile() {
            return this.home_land().Data($bog_wikilive_profile);
        }
        player_id() {
        ...
        favorite_link_strs() {
            ...
            return items.filter((link) => link !== null).map(link => link.str);
        }
        recent_link_strs() {
            const items = this.profile().Recent()?.items() ?? [];
            return items.filter((link) => link !== null).map(link => link.str);
        }
        favorite_toggle(link_str) {
        ...
        page_links() {
            ...
            return items.filter((link) => link !== null);
        }
        doc_by_link(link_str) {
            const land = this.glob().Land(new $giper_baza_link(link_str));
            return land.Data($bog_wikilive_doc);
        }
        page_link_strs() {
        ...
        child_link_strs(parent_link_str) {
            const doc = this.doc_by_link(parent_link_str);
            const children = doc.Children()?.items() ?? [];
            return children.filter((link) => link !== null).map(link => link.str);
        }
        static templates = {
        ...
        page_create(title, parent_link_str, template = 'blank') {
            ...
            const doc = land.Data($bog_wikilive_doc);
        ...
        page_move(child_link_str, new_parent_link_str) {
    ...
    __decorate([
        $mol_mem
    ], $bog_wikilive_store.prototype, "favorite_link_strs", null);
    __decorate([
        $mol_mem
    ], $bog_wikilive_store.prototype, "recent_link_strs", null);
    __decorate([
        $mol_action
    ], $bog_wikilive_store.prototype, "favorite_toggle", null);
    __decorate([
        $mol_action
    ], $bog_wikilive_store.prototype, "recent_add", null);
    __decorate([
        $mol_mem
    ], $bog_wikilive_store.prototype, "search_results", null);
    __decorate([
        $mol_mem
    ], $bog_wikilive_store.prototype, "page_links", null);
    __decorate([
        $mol_mem
    ], $bog_wikilive_store.prototype, "page_link_strs", null);
    __decorate([
        $mol_mem
    ], $bog_wikilive_store.prototype, "root_link_strs", null);
    __decorate([
        $mol_action
    ], $bog_wikilive_store.prototype, "page_create", null);
    __decorate([
        $mol_action
    ], $bog_wikilive_store.prototype, "page_move", null);
    __decorate([
        $mol_action
    ], $bog_wikilive_store.prototype, "page_delete", null);
    $.$bog_wikilive_store = $bog_wikilive_store;
})($ || ($ = {}));
...
;
	($.$bog_wikilive_tree_node) = class $bog_wikilive_tree_node extends ($.$mol_view) {
		Expand_icon(){
		...
		Title(){
			const obj = new this.$.$mol_button_minor();
			(obj.title) = () => ((this.title()));
			(obj.click) = (next) => ((this.select(next)));
			return obj;
		}
		Drag(){
		...
		Drop(){
			...
			(obj.Sub) = () => ((this.Row()));
			(obj.receive) = (next) => ((this.drop_receive(next)));
			return obj;
		}
		child_nodes(){
			return [];
		...
		Child_node(id){
			const obj = new this.$.$bog_wikilive_tree_node();
			(obj.page_link) = () => ((this.child_page_link(id)));
			(obj.store) = () => ((this.store()));
			(obj.level) = () => ((this.child_level()));
			(obj.page_selected) = (next) => ((this.page_selected(next)));
			return obj;
		}
		attr(){
			return {
				...(super.attr()), 
				"bog_wikilive_tree_node_level": (this.level()), 
				"bog_wikilive_tree_node_active": (this.active())
			};
		}
	};
	($mol_mem(($.$bog_wikilive_tree_node.prototype), "Expand_icon"));
	($mol_mem(($.$bog_wikilive_tree_node.prototype), "Expand"));
	($mol_mem(($.$bog_wikilive_tree_node.prototype), "select"));
	($mol_mem(($.$bog_wikilive_tree_node.prototype), "Title"));
	($mol_mem(($.$bog_wikilive_tree_node.prototype), "Drag"));
	($mol_mem(($.$bog_wikilive_tree_node.prototype), "Row"));
	($mol_mem(($.$bog_wikilive_tree_node.prototype), "drop_receive"));
	($mol_mem(($.$bog_wikilive_tree_node.prototype), "Drop"));
	($mol_mem(($.$bog_wikilive_tree_node.prototype), "Children"));
	($mol_mem(($.$bog_wikilive_tree_node.prototype), "store"));
	($mol_mem(($.$bog_wikilive_tree_node.prototype), "page_selected"));
	($mol_mem(($.$bog_wikilive_tree_node.prototype), "expanded"));
	($mol_mem_key(($.$bog_wikilive_tree_node.prototype), "Child_node"));
...
(function ($) {
    ...
    (function ($$) {
        class $bog_wikilive_tree_node extends $.$bog_wikilive_tree_node {
            ...
            select(next) {
                if (next !== undefined)
                    this.page_selected(this.page_link());
                return null;
            }
            child_level() {
                return this.level() + 1;
            ...
            child_nodes() {
                return this.child_link_strs().map((_, index) => this.Child_node(index));
            }
            child_page_link(index) {
            ...
            drop_receive(transfer) {
                if (!transfer)
                    return null;
                const dragged_link = transfer.getData('text/plain');
                if (!dragged_link || dragged_link === this.page_link())
                    return null;
        ...
        __decorate([
            $mol_action
        ], $bog_wikilive_tree_node.prototype, "select", null);
        __decorate([
            $mol_mem
        ], $bog_wikilive_tree_node.prototype, "child_link_strs", null);
        __decorate([
            $mol_mem
        ], $bog_wikilive_tree_node.prototype, "child_nodes", null);
        __decorate([
            $mol_action
        ], $bog_wikilive_tree_node.prototype, "drop_receive", null);
        $$.$bog_wikilive_tree_node = $bog_wikilive_tree_node;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
;
	($.$bog_wikilive_tree) = class $bog_wikilive_tree extends ($.$mol_list) {
		root_nodes(){
			return [];
		}
		root_page_link(id){
		...
		Root_node(id){
			const obj = new this.$.$bog_wikilive_tree_node();
			(obj.page_link) = () => ((this.root_page_link(id)));
			(obj.store) = () => ((this.store()));
			(obj.level) = () => (0);
			(obj.page_selected) = (next) => ((this.page_selected(next)));
			return obj;
	...
	($mol_mem(($.$bog_wikilive_tree.prototype), "page_selected"));
	($mol_mem(($.$bog_wikilive_tree.prototype), "store"));
	($mol_mem_key(($.$bog_wikilive_tree.prototype), "Root_node"));
...
(function ($) {
    ...
    (function ($$) {
        class $bog_wikilive_tree extends $.$bog_wikilive_tree {
            root_nodes() {
                return this.store().root_link_strs().map((_, index) => this.Root_node(index));
            }
            root_page_link(index) {
                return this.store().root_link_strs()[index] ?? '';
            }
        }
        __decorate([
            $mol_mem
        ], $bog_wikilive_tree.prototype, "root_nodes", null);
...
var $;
(function ($) {
    $mol_style_define($bog_wikilive_tree, {
        flex: {
            grow: 1,
        },
        overflow: {
...
;
	($.$bog_wikilive_page) = class $bog_wikilive_page extends ($.$mol_page) {
		page_title(next){
			if(next !== undefined) return next;
			return "Без названия";
		}
		...
		Breadcrumb(){
			...
			(obj.crumbs) = () => ((this.breadcrumb_ids()));
			(obj.crumb_title) = (id) => ((this.breadcrumb_title(id)));
			(obj.crumb_uri) = (id) => ((this.breadcrumb_uri(id)));
			(obj.last_title) = () => ((this.page_title()));
			return obj;
		}
		Title_edit(){
			const obj = new this.$.$mol_string_button();
			(obj.value) = (next) => ((this.page_title(next)));
			(obj.hint) = () => ("Название страницы");
			return obj;
		}
		editor_avatars(){
			return [];
		...
		Fav_toggle(){
			const obj = new this.$.$mol_check_icon();
			(obj.checked) = (next) => ((this.is_favorite(next)));
			(obj.Icon) = () => ((this.Fav_icon()));
			return obj;
		}
		editing(next){
			if(next !== undefined) return next;
		...
		Add_table(){
			const obj = new this.$.$mol_button_minor();
			(obj.hint) = () => ("Добавить таблицу");
			(obj.click) = (next) => ((this.table_add(next)));
			(obj.sub) = () => ([(this.Table_icon())]);
			return obj;
		}
		history_toggle(next){
			if(next !== undefined) return next;
		...
		History_toggle(){
			const obj = new this.$.$mol_button_minor();
			(obj.hint) = () => ("История изменений");
			(obj.click) = (next) => ((this.history_toggle(next)));
			(obj.sub) = () => ([(this.History_icon())]);
			return obj;
		}
		child_add(next){
			if(next !== undefined) return next;
		...
		Add_child(){
			const obj = new this.$.$mol_button_minor();
			(obj.hint) = () => ("Добавить дочернюю страницу");
			(obj.click) = (next) => ((this.child_add(next)));
		...
		Export(){
			...
			(obj.hint) = () => ("Скачать Markdown");
			(obj.file_name) = () => ((this.export_filename()));
			(obj.uri) = () => ((this.export_uri()));
			return obj;
		}
		page_delete(next){
			if(next !== undefined) return next;
		...
		History_close(){
			const obj = new this.$.$mol_button_minor();
			(obj.click) = (next) => ((this.history_close(next)));
			(obj.sub) = () => ([(this.History_close_icon())]);
			return obj;
		}
		history_items(){
			return [];
		}
		history_entry_peer(id){
			return "";
		}
		History_entry_avatar(id){
			const obj = new this.$.$mol_avatar();
			(obj.id) = () => ((this.history_entry_peer(id)));
			return obj;
		}
		history_entry_time(id){
			return "";
		}
		history_entry_changes(id){
			return "";
		}
		History_entry_info(id){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([
				(this.history_entry_peer(id)), 
				(this.history_entry_time(id)), 
				(this.history_entry_changes(id))
			]);
			return obj;
		}
		store(){
		...
		Editor(){
			...
			(obj.value) = (next) => ((this.content(next)));
			(obj.hint) = () => ("Пишите в Markdown...");
			return obj;
		}
		Table_view(id){
			const obj = new this.$.$bog_wikilive_table_view();
			(obj.table) = () => ((this.table_entity(id)));
			return obj;
		}
		Editor_avatar(id){
			const obj = new this.$.$mol_avatar();
		...
		History(){
			...
			(obj.content) = () => ((this.history_content()));
			return obj;
		}
		History_header(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.History_title()), (this.History_close())]);
			return obj;
		}
		History_list(){
			const obj = new this.$.$mol_list();
		...
		History_entry(id){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.History_entry_avatar(id)), (this.History_entry_info(id))]);
			return obj;
		}
	};
	($mol_mem(($.$bog_wikilive_page.prototype), "page_title"));
	($mol_mem(($.$bog_wikilive_page.prototype), "Breadcrumb"));
	($mol_mem(($.$bog_wikilive_page.prototype), "Title_edit"));
	($mol_mem(($.$bog_wikilive_page.prototype), "Editors"));
	($mol_mem(($.$bog_wikilive_page.prototype), "is_favorite"));
	($mol_mem(($.$bog_wikilive_page.prototype), "Fav_icon"));
	($mol_mem(($.$bog_wikilive_page.prototype), "Fav_toggle"));
	($mol_mem(($.$bog_wikilive_page.prototype), "editing"));
	($mol_mem(($.$bog_wikilive_page.prototype), "Edit_icon"));
	($mol_mem(($.$bog_wikilive_page.prototype), "Edit_toggle"));
	($mol_mem(($.$bog_wikilive_page.prototype), "table_add"));
	($mol_mem(($.$bog_wikilive_page.prototype), "Table_icon"));
	($mol_mem(($.$bog_wikilive_page.prototype), "Add_table"));
	($mol_mem(($.$bog_wikilive_page.prototype), "history_toggle"));
	($mol_mem(($.$bog_wikilive_page.prototype), "History_icon"));
	($mol_mem(($.$bog_wikilive_page.prototype), "History_toggle"));
	($mol_mem(($.$bog_wikilive_page.prototype), "child_add"));
	($mol_mem(($.$bog_wikilive_page.prototype), "Add_icon"));
	($mol_mem(($.$bog_wikilive_page.prototype), "Add_child"));
	($mol_mem(($.$bog_wikilive_page.prototype), "Export"));
	($mol_mem(($.$bog_wikilive_page.prototype), "page_delete"));
	($mol_mem(($.$bog_wikilive_page.prototype), "Delete_icon"));
	($mol_mem(($.$bog_wikilive_page.prototype), "Delete"));
	($mol_mem(($.$bog_wikilive_page.prototype), "content"));
	($mol_mem_key(($.$bog_wikilive_page.prototype), "table_entity"));
	($mol_mem(($.$bog_wikilive_page.prototype), "history_showed"));
	($mol_mem(($.$bog_wikilive_page.prototype), "History_title"));
	($mol_mem(($.$bog_wikilive_page.prototype), "history_close"));
	($mol_mem(($.$bog_wikilive_page.prototype), "History_close_icon"));
	($mol_mem(($.$bog_wikilive_page.prototype), "History_close"));
	($mol_mem_key(($.$bog_wikilive_page.prototype), "History_entry_avatar"));
	($mol_mem_key(($.$bog_wikilive_page.prototype), "History_entry_info"));
	($mol_mem(($.$bog_wikilive_page.prototype), "store"));
	($mol_mem(($.$bog_wikilive_page.prototype), "View"));
	($mol_mem(($.$bog_wikilive_page.prototype), "Editor"));
	($mol_mem_key(($.$bog_wikilive_page.prototype), "Table_view"));
	($mol_mem_key(($.$bog_wikilive_page.prototype), "Editor_avatar"));
	($mol_mem(($.$bog_wikilive_page.prototype), "History"));
	($mol_mem(($.$bog_wikilive_page.prototype), "History_header"));
	($mol_mem(($.$bog_wikilive_page.prototype), "History_list"));
	($mol_mem_key(($.$bog_wikilive_page.prototype), "History_entry"));
...
(function ($) {
    ...
    (function ($$) {
        class $bog_wikilive_page extends $.$bog_wikilive_page {
            ...
            editor_avatars() {
                return this.editor_peers().slice(0, 5).map((_, i) => this.Editor_avatar(i));
            }
            editor_id(index) {
            ...
            table_views() {
                return this.doc().table_list().map((_, i) => this.Table_view(i));
            }
            table_entity(index) {
        ...
        __decorate([
            $mol_mem
        ], $bog_wikilive_page.prototype, "page_title", null);
        __decorate([
            $mol_mem
        ], $bog_wikilive_page.prototype, "content", null);
        __decorate([
            $mol_mem
        ], $bog_wikilive_page.prototype, "face_entries", null);
        __decorate([
            $mol_mem
        ], $bog_wikilive_page.prototype, "editor_peers", null);
        __decorate([
            $mol_mem
        ], $bog_wikilive_page.prototype, "editor_avatars", null);
        __decorate([
            $mol_mem
        ], $bog_wikilive_page.prototype, "history_content", null);
        __decorate([
            $mol_mem
        ], $bog_wikilive_page.prototype, "history_items", null);
        __decorate([
            $mol_mem
        ], $bog_wikilive_page.prototype, "is_favorite", null);
        __decorate([
            $mol_action
        ], $bog_wikilive_page.prototype, "history_toggle", null);
        __decorate([
            $mol_action
        ], $bog_wikilive_page.prototype, "history_close", null);
        __decorate([
            $mol_mem
        ], $bog_wikilive_page.prototype, "table_views", null);
        __decorate([
            $mol_mem
        ], $bog_wikilive_page.prototype, "body_content", null);
        __decorate([
            $mol_mem
        ], $bog_wikilive_page.prototype, "sub", null);
        __decorate([
            $mol_mem
        ], $bog_wikilive_page.prototype, "breadcrumb_chain", null);
        __decorate([
            $mol_mem
        ], $bog_wikilive_page.prototype, "breadcrumb_ids", null);
        __decorate([
            $mol_mem
        ], $bog_wikilive_page.prototype, "export_filename", null);
        __decorate([
            $mol_mem
        ], $bog_wikilive_page.prototype, "export_uri", null);
        __decorate([
            $mol_action
        ], $bog_wikilive_page.prototype, "table_add", null);
        __decorate([
            $mol_action
        ], $bog_wikilive_page.prototype, "child_add", null);
        __decorate([
            $mol_action
        ], $bog_wikilive_page.prototype, "page_delete", null);
        $$.$bog_wikilive_page = $bog_wikilive_page;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
;
	($.$bog_wikilive_search) = class $bog_wikilive_search extends ($.$mol_page) {
		query(next){
			if(next !== undefined) return next;
			return "";
		}
	...
	($mol_mem(($.$bog_wikilive_search.prototype), "query"));
	($mol_mem(($.$bog_wikilive_search.prototype), "Search"));
	($mol_mem(($.$bog_wikilive_search.prototype), "Results"));
	($mol_mem(($.$bog_wikilive_search.prototype), "Empty"));
	($mol_mem_key(($.$bog_wikilive_search.prototype), "result_click"));
	($mol_mem(($.$bog_wikilive_search.prototype), "store"));
	($mol_mem(($.$bog_wikilive_search.prototype), "page_selected"));
	($mol_mem_key(($.$bog_wikilive_search.prototype), "Result_row"));
...
(function ($) {
    ...
    (function ($$) {
        ...
        __decorate([
            $mol_mem
        ], $bog_wikilive_search.prototype, "results", null);
        __decorate([
            $mol_mem
        ], $bog_wikilive_search.prototype, "result_rows", null);
        __decorate([
            $mol_action
        ], $bog_wikilive_search.prototype, "result_click", null);
...
;
	($.$bog_wikilive_app) = class $bog_wikilive_app extends ($.$mol_book2) {
		...
		Logo(){
			const obj = new this.$.$bog_wikilive_logo();
			return obj;
		}
		Nav_header(){
			const obj = new this.$.$mol_view();
		...
		Home_nav(){
			...
			(obj.Icon) = () => ((this.Home_icon()));
			(obj.label) = () => ("Главная");
			(obj.active) = () => ((this.home_active()));
			(obj.click) = (next) => ((this.nav_home(next)));
			return obj;
		}
		Search_icon(){
		...
		Search_nav(){
			...
			(obj.click) = (next) => ((this.nav_search(next)));
			return obj;
		}
		Profile_icon(){
		...
		Profile_nav(){
			...
			(obj.label) = () => ("Профиль");
			(obj.active) = () => ((this.profile_active()));
			(obj.click) = (next) => ((this.nav_profile(next)));
			return obj;
		}
		add_menu_showed(next){
			if(next !== undefined) return next;
			return false;
		}
		add_menu_toggle(next){
			if(next !== undefined) return next;
			return null;
		}
		Add_page(){
			const obj = new this.$.$mol_button_minor();
			(obj.title) = () => ("+ Страница");
			(obj.click) = (next) => ((this.add_menu_toggle(next)));
			return obj;
		}
		page_create_blank(next){
			if(next !== undefined) return next;
			return null;
		}
		Add_blank(){
			const obj = new this.$.$mol_button_minor();
			(obj.title) = () => ("Пустая");
			(obj.click) = (next) => ((this.page_create_blank(next)));
			return obj;
		}
		page_create_meeting(next){
			if(next !== undefined) return next;
			return null;
		}
		Add_meeting(){
			const obj = new this.$.$mol_button_minor();
			(obj.title) = () => ("Протокол встречи");
			(obj.click) = (next) => ((this.page_create_meeting(next)));
			return obj;
		}
		page_create_spec(next){
			if(next !== undefined) return next;
			return null;
		}
		Add_spec(){
			const obj = new this.$.$mol_button_minor();
			(obj.title) = () => ("Спецификация");
			(obj.click) = (next) => ((this.page_create_spec(next)));
			return obj;
		}
		page_create_guide(next){
			if(next !== undefined) return next;
			return null;
		}
		Add_guide(){
			const obj = new this.$.$mol_button_minor();
			(obj.title) = () => ("Руководство");
			(obj.click) = (next) => ((this.page_create_guide(next)));
			return obj;
		}
		Add_menu(){
			const obj = new this.$.$mol_pop();
			(obj.showed) = (next) => ((this.add_menu_showed(next)));
			(obj.Anchor) = () => ((this.Add_page()));
			(obj.bubble_content) = () => ([
				(this.Add_blank()), 
				(this.Add_meeting()), 
				(this.Add_spec()), 
		...
		Welcome_text(){
			const obj = new this.$.$mol_text();
			(obj.text) = () => ("# Добро пожаловать в WikiLive\n\nВыберите страницу в дереве слева или создайте новую.");
			return obj;
		}
		plugins(){
			return [(this.Theme())];
		...
		pages(){
			return [(this.Nav()), (this.Content())];
		}
		Tree(){
			const obj = new this.$.$bog_wikilive_tree();
			(obj.store) = () => ((this.store()));
			(obj.page_selected) = (next) => ((this.page_selected(next)));
			return obj;
		}
		Page(){
			const obj = new this.$.$bog_wikilive_page();
			(obj.store) = () => ((this.store()));
			(obj.page_link) = () => ((this.page_selected()));
			return obj;
		}
		Welcome(){
			const obj = new this.$.$mol_page();
			(obj.title) = () => ("WikiLive");
			(obj.body) = () => ([(this.Welcome_text())]);
			return obj;
		}
		Profile(){
			const obj = new this.$.$bog_wikilive_profile_page();
			(obj.store) = () => ((this.store()));
			(obj.page_selected) = (next) => ((this.page_selected(next)));
			return obj;
		}
		Search(){
			const obj = new this.$.$bog_wikilive_search();
			(obj.store) = () => ((this.store()));
			(obj.page_selected) = (next) => ((this.page_selected(next)));
			return obj;
		}
	...
	($mol_mem(($.$bog_wikilive_app.prototype), "sidebar_mode"));
	($mol_mem(($.$bog_wikilive_app.prototype), "Logo"));
	($mol_mem(($.$bog_wikilive_app.prototype), "Nav_header"));
	($mol_mem(($.$bog_wikilive_app.prototype), "Home_icon"));
	($mol_mem(($.$bog_wikilive_app.prototype), "nav_home"));
	($mol_mem(($.$bog_wikilive_app.prototype), "Home_nav"));
	($mol_mem(($.$bog_wikilive_app.prototype), "Search_icon"));
	($mol_mem(($.$bog_wikilive_app.prototype), "nav_search"));
	($mol_mem(($.$bog_wikilive_app.prototype), "Search_nav"));
	($mol_mem(($.$bog_wikilive_app.prototype), "Profile_icon"));
	($mol_mem(($.$bog_wikilive_app.prototype), "nav_profile"));
	($mol_mem(($.$bog_wikilive_app.prototype), "Profile_nav"));
	($mol_mem(($.$bog_wikilive_app.prototype), "add_menu_showed"));
	($mol_mem(($.$bog_wikilive_app.prototype), "add_menu_toggle"));
	($mol_mem(($.$bog_wikilive_app.prototype), "Add_page"));
	($mol_mem(($.$bog_wikilive_app.prototype), "page_create_blank"));
	($mol_mem(($.$bog_wikilive_app.prototype), "Add_blank"));
	($mol_mem(($.$bog_wikilive_app.prototype), "page_create_meeting"));
	($mol_mem(($.$bog_wikilive_app.prototype), "Add_meeting"));
	($mol_mem(($.$bog_wikilive_app.prototype), "page_create_spec"));
	($mol_mem(($.$bog_wikilive_app.prototype), "Add_spec"));
	($mol_mem(($.$bog_wikilive_app.prototype), "page_create_guide"));
	($mol_mem(($.$bog_wikilive_app.prototype), "Add_guide"));
	($mol_mem(($.$bog_wikilive_app.prototype), "Add_menu"));
	($mol_mem(($.$bog_wikilive_app.prototype), "Lighter"));
	($mol_mem(($.$bog_wikilive_app.prototype), "Nav_footer"));
	($mol_mem(($.$bog_wikilive_app.prototype), "Nav"));
	($mol_mem(($.$bog_wikilive_app.prototype), "Content"));
	($mol_mem(($.$bog_wikilive_app.prototype), "page_selected"));
	($mol_mem(($.$bog_wikilive_app.prototype), "Welcome_text"));
	($mol_mem(($.$bog_wikilive_app.prototype), "Tree"));
	($mol_mem(($.$bog_wikilive_app.prototype), "Page"));
	($mol_mem(($.$bog_wikilive_app.prototype), "Welcome"));
	($mol_mem(($.$bog_wikilive_app.prototype), "Profile"));
	($mol_mem(($.$bog_wikilive_app.prototype), "Search"));
	($mol_mem(($.$bog_wikilive_app.prototype), "store"));
	($mol_mem(($.$bog_wikilive_app.prototype), "screen"));
    ...
    (function ($$) {
        ...
        class $bog_wikilive_app extends $.$bog_wikilive_app {
            ...
            content_pages() {
                ...
                if (selected) {
                    try {
                        this.store().recent_add(selected);
                    }
                    catch { }
                    return [this.Page()];
                }
        ...
        __decorate([
            $mol_mem
        ], $bog_wikilive_app.prototype, "size_watcher", null);
        __decorate([
            $mol_mem
        ], $bog_wikilive_app.prototype, "screen", null);
        __decorate([
            $mol_mem
        ], $bog_wikilive_app.prototype, "page_selected", null);
        __decorate([
            $mol_mem
        ], $bog_wikilive_app.prototype, "home_active", null);
        __decorate([
            $mol_mem
        ], $bog_wikilive_app.prototype, "search_active", null);
        __decorate([
            $mol_mem
        ], $bog_wikilive_app.prototype, "profile_active", null);
        __decorate([
            $mol_action
        ], $bog_wikilive_app.prototype, "nav_home", null);
        __decorate([
            $mol_action
        ], $bog_wikilive_app.prototype, "nav_search", null);
        __decorate([
            $mol_action
        ], $bog_wikilive_app.prototype, "nav_profile", null);
        __decorate([
            $mol_mem
        ], $bog_wikilive_app.prototype, "content_pages", null);
        __decorate([
            $mol_mem
        ], $bog_wikilive_app.prototype, "pages", null);
        __decorate([
            $mol_action
        ], $bog_wikilive_app.prototype, "add_menu_toggle", null);
        __decorate([
            $mol_action
        ], $bog_wikilive_app.prototype, "page_create_blank", null);
        __decorate([
            $mol_action
        ], $bog_wikilive_app.prototype, "page_create_meeting", null);
        __decorate([
            $mol_action
        ], $bog_wikilive_app.prototype, "page_create_spec", null);
        __decorate([
            $mol_action
        ], $bog_wikilive_app.prototype, "page_create_guide", null);
